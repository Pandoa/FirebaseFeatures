...
2. [Setup Firebase Features](#2-setup-firebase-features)  
  2.1. [Create a Firebase project](#21-create-a-firebase-project)  
  2.2. [AdMob Configuration](#22-admob-configuration)  
  2.3. [`google-services.json`](#23-google-servicesjson)  
  2.4. [Create a Realtime Database](#24-creating-a-realtime-database)  
  2.5. [Configuration for C++](#25-configuration-for-c)  
3. [Firebase Components](#3-firebase-components)  
  3.1. [AdMob](#31-admob)  
  3.2. [Analytics](#32-analytics)  
  3.3. [Auth](#33-auth)  
  3.4. [Cloud Firestore](#34-cloud-firestore)  
  3.5. [Cloud Functions](#35-cloud-functions)  
  3.6. [Cloud Messaging](#36-cloud-messaging)  
  3.7. [Cloud Storage](#37-cloud-storage)  
  3.8. [Dynamic Links](#38-dynamic-links)  
  3.9. [Realtime Database](#39-realtime-database)  
  3.10. [Remote Config](#310-remote-config)  
4. [Troubleshoting](#4-troubleshoting)
5. [Support](#5-support)
...
## 2.4. Creating a Realtime Database
...
#### 3.1.1.2. Adding the Device ID for Development
...
```
### 3.2.2. Managing the Analytic Session
...
### 4.1.2. Error: Cook failed. Editor terminated with exit code `16384`.
